...
class XSSEncodeAngles(object):
    ...
    def filter(user_input):
        ...
        #DONE: 1 of 2 in this file. Complete this filter definition to replace < and > with their HTML entities
...
class CSRFToken(object):
    ...
    def init(request, response):
        ...
        #DONE: 2 of 2 in this file. Implement a CSRF token (see pseudocode in handout)
        if token is None:
